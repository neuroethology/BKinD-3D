...
import sys 
sys.path.append('/home/amildravid/BKinD-main/Depth/depth3_multi-BKinD3D')
import os
import os.path
...
def generate_pair_images(mode,root, subjects, actions, gap=20):
    images = []
    ...
    for subject in subjects:
        ...
        for action in actions:
            ...
            if not(subject == "S11" and action == "Directions-2"):
                ...
                if mode == "train":
                    ...
                    k =1
                for framenum in range(len(frame_names)//k):
                    bad = False
                    allcams_item = []
                    allcams_gt = []
                    for cam_name in camera_names:
                        ...
                        allcams_gt.append([annos['pose']['3d'][ix_1],annos['pose']['3d'][ix_2] ])
                    if bad:
                        continue
                    images.append({"calibration": calibration,
                                   "items": allcams_item,
                                 "ground_truth": allcams_gt} )
...
class H36MDataset(data.Dataset):
    ...
    def __init__(self, mode, root, transform=None, target_transform=None,
        ...
        samples = generate_pair_images(mode, root, subjects, actions, gap=frame_gap)
    ...
    def __getitem__(self, index):
        ...
        for i in range(num_cameras):
            ...
            gt_0, gt_1 = image_dict['ground_truth'][i]
            ...
            all_cam_items['ground_truth'].append((gt_0, gt_1))     
